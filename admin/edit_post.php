	  			...
	  			<div class="col-md-12">
	  				<?php 
	  					if (isset($_GET['edit_id'])) 
	  					{
	  						...
	  						<div class=""><h3><?php echo $rows['title']; ?><hr></h3></div>
		  				<div style="width: 50px;"></div>
		  				<form class="from-horizontal" action="new_post.php" method="post" enctype="multipart/form-data">
		  						<img src="../image/<?php echo $rows['image'];  ?>"width="100px" style="margin-left: 32px;">
		  					...
		  					<div class="from-group">
			  					...
			  					<div class="col-sm-8">
			  						<input type="text" class="form-control" name="title" value="<?php echo $rows['title']; ?>" id="title" placeholder="Enter Title" required="" autofocus="" />
			  					</div>
		  					</div>		  					
		  					<div class="from-group">
			  					...
			  					<div class="col-sm-8">
			  						<select class="form-control" name="category">
			  							...
			  							<?php
			  								...
			  								while ($c_rows = mysqli_fetch_assoc($run_qry)) 
			  								{
		  					...
		  					<div class="from-group">
			  					...
			  					<div class="col-sm-8">
			  						<textarea name="description" id="description" rows="5"  class="tinymce"><?php echo $rows['description']; ?></textarea>
			  					</div>
		  					</div>
		  					<div class="from-group">
	  					...
	  					<?php } 
			  						...
			  						echo '<div class="alert alert-danger">Oops!! Pelese Select posts to edit!!</div>';	
			  					}
	  				 ?>		  			
		  		</div>
	  		</div>
